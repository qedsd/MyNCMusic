...
namespace MyNCMusic.Helper
{
    ...
    public class Http
    {
        ...
        /// GET方法(自动维护cookie)
        /// </summary>
        public static async Task<string> GetAsync(string url, string referer = "", int timeout = 2000, Encoding encode = null)
        {
            string dat;
            HttpWebResponse res;
            HttpWebRequest req;
        ...
        /// Post方法(自动维护cookie)
        /// </summary>
        public static async Task<string> PostAsync(string url, string postdata, CookieContainer cookie = null, string referer = "", int timeout = 2000, Encoding encode = null)
        {
            string html;
            HttpWebRequest request;
            HttpWebResponse response;
